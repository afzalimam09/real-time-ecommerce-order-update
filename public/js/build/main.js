...
var initAdmin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(socket) {
    var orderTableBody, orders, markup, renderItems, generateMarkup, res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 5;
            _context.next = 8;
            return axios__WEBPACK_IMPORTED_MODULE_0__.get('/admin/orders', {
              headers: {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0__.post("/add-to-cart", product);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0__.post("/delete-from-cart", product);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initCart);
...
/*!*******************************!*\
  ...
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _cart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cart.js */ "./public/js/src/cart.js");
/* harmony import */ var _admin_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./admin.js */ "./public/js/src/admin.js");
...
var navElems = [menuOpenBtn, menuCloseBtn];
...
window.addEventListener("scroll", function () {
  window.scrollY >= 100 ? backTopBtn.classList.add("a-ctive") : backTopBtn.classList.remove("active");
});
(0,_cart_js__WEBPACK_IMPORTED_MODULE_0__["default"])(); // Order Status Update
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_2__(order.updatedAt).format("hh:mm A");
...
if (adminAreaPath.includes('admin')) {
  (0,_admin_js__WEBPACK_IMPORTED_MODULE_1__["default"])(socket);
